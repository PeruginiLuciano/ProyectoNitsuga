...
class MHIcons {
  ...
  // Animated
  static const String sliderClosed = "$_icons/slider_closed.svg";
  static const String table = "$_icons/table.svg";
  static const String awning = "$_icons/awning.svg";
  static const String leveler = "$_icons/leveler.svg";
  static const String levelerRadar = "$_icons/leveler_radar.svg";
}

class MHAnimations {
  static const String _baseAnimated = "assets/animated";

  static const String sliderOpening = "$_baseAnimated/slider_opening.json";
  static const String sliderClosing = "$_baseAnimated/slider_closing.json";
  static const String tableOpening = "$_baseAnimated/table_opening.json";
  static const String tableClosing = "$_baseAnimated/table_closing.json";
  static const String niveladorOpen = "$_baseAnimated/nivelador_abre.json";
  static const String niveladorClose = "$_baseAnimated/toldolador_cierra.json";
  static const String awningOpening = "$_baseAnimated/awning_opening.json";
  static const String awningClosing = "$_baseAnimated/awning_closing.json";
}
